CREATE PROC [dbo].[SP_OZ3120_Cust_Items_Total]
...
Begin
	...
	SELECT SUM(CASE WHEN A.AR = 'Yes' THEN A.COGS ELSE 0 END) AS COGS,
		SUM(CASE WHEN A.AR = 'Yes' THEN A.EXTINVMISC ELSE 0 END) AS EXTINVMISC,
		SUM(CASE WHEN A.AR = 'No' THEN A.ORDAMT ELSE 0 END) AS ORDAMT,
		SUM(CASE WHEN A.AR = 'Yes' THEN A.EXTINVMISC ELSE ORDAMT END) AS TOTALAMT
	FROM (
		--Invoice
