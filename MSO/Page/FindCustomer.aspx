<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FindCustomer.aspx.cs" Inherits="MSO.Page.FindCustomer" EnableSessionState="ReadOnly" %>
...
<div class="title">거래선 관리</div>
    ...
    <div>
            ...
            <tr>
                <td colspan="4">검색 조건:
                    <asp:DropDownList ID="ddl_Type" runat="server">
                        ...
                        <asp:ListItem Value="NAMECTAC">당담자</asp:ListItem>
                    </asp:DropDownList>
                    ...
                    <table id="tab" class="tableList_01">
                        ...
                        <tbody>
                            <asp:Repeater ID="rep_List" runat="server">
                                <ItemTemplate>
                                    <tr style='cursor: pointer' onclick="getCustomer('<%#Eval("IDCUST")%>','<%#Eval("NAMECUST")%>')">
        ...
        <table style="width: 825px">
            <tr>
                <td><asp:Label ID="lbl_nodata" runat="server" /></td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        function getCustomer(ccode, cname) {
            window.opener.getCustomer(ccode, cname);
            window.close();
        }
